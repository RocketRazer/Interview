 ...
 * <p>
 * https://www.airbnb.com/rooms/kljjj324hjks_      // 大小写 messed up
 * <p>
...
public class DecodableID {
    ...
    private Integer dfs(String str, int start, StringBuilder sb) {
        // recursion exit
        if (start == str.length()) {
        ...
        if (Character.isDigit(c)) {
            sb.append(c);
            Integer res = dfs(str, start + 1, sb);
            if (res != null) {
                return res;
            }
