...
public class Ip2Cidr {
    ...
    private String longToIP(long longIP) {
        ...
        sb.append(".");
        sb.append(String.valueOf((longIP & 0x00FFFFFF) >>> 16)); // 0x0000FFFF = 111111111111111111111111 (24)
        sb.append(".");
        sb.append(String.valueOf((longIP & 0x0000FFFF) >>> 8));// 0x0000FFFF = 1111111111111111 (16)
        sb.append(".");
        sb.append(String.valueOf(longIP & 0x000000FF));  // 0x000000FF = 11111111 (8)
